...
public class AddressBookUc2 {
    ...
    public static void main(String[] args) {
		...
		AddressBookUc2 addressbook1 = new AddressBookUc2();
		ArrayList<AddressBookUc2> ll=new ArrayList<AddressBookUc2>();
		ArrayList<AddressBookUc2> l=new ArrayList<AddressBookUc2>();
		 ...
		 l.add(addressbook1);
		 ll.addAll(l);
		 System.out.println("All list"+ll);
