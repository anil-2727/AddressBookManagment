...
public class AddressBookUc3 {
	...
	public static void main(String[] args) {
		...
		AddressBookUc3 addressbook1 = new AddressBookUc3();
		ArrayList<AddressBookUc3> l1 = new ArrayList<AddressBookUc3>();
		ArrayList<AddressBookUc3> l = new ArrayList<AddressBookUc3>();
