...
public class AdressBookUc4 {
	...
	public static void main(String[] args) {
		...
		try {
			AdressBookUc4  addressbook = new AdressBookUc4 ();
			AdressBookUc4  addressbook1 = new AdressBookUc4 ();
			ArrayList<AdressBookUc4 > l1 = new ArrayList<AdressBookUc4 >();
			ArrayList<AdressBookUc4 > l = new ArrayList<AdressBookUc4 >();
